...
# Visualize results
ggplot(data.frame(tSNE1 = umap.cor$layout[,1],
                  tSNE2 = umap.cor$layout[,2],
...
# Visualize only BE
ggplot(data.frame(tSNE1 = umap.cor$layout[colData(cur_sce)$Tissue == "BE",1],
                  tSNE2 = umap.cor$layout[colData(cur_sce)$Tissue == "BE",2],
                  patient = as.factor(colData(cur_sce[,colData(cur_sce)$Tissue == "BE"])$Patient))) +
  geom_point(aes(tSNE1, tSNE2, colour = patient)) + 
  scale_color_manual(values = c(brewer.pal(n = 12, name = "Set3")))

# Visualize only GC
ggplot(data.frame(tSNE1 = umap.cor$layout[colData(cur_sce)$Tissue == "GC",1],
                  tSNE2 = umap.cor$layout[colData(cur_sce)$Tissue == "GC",2],
                  patient = as.factor(colData(cur_sce[,colData(cur_sce)$Tissue == "GC"])$Patient))) +
  geom_point(aes(tSNE1, tSNE2, colour = patient)) + 
  scale_color_manual(values = c(brewer.pal(n = 12, name = "Set3")))

# Visualize only SMG
ggplot(data.frame(tSNE1 = umap.cor$layout[colData(cur_sce)$Tissue == "SMG",1],
                  tSNE2 = umap.cor$layout[colData(cur_sce)$Tissue == "SMG",2],
                  patient = as.factor(colData(cur_sce[,colData(cur_sce)$Tissue == "SMG"])$Patient))) +
  geom_point(aes(tSNE1, tSNE2, colour = patient)) + 
  scale_color_manual(values = c(brewer.pal(n = 12, name = "Set3")))

# Visualize only D2
ggplot(data.frame(tSNE1 = umap.cor$layout[colData(cur_sce)$Tissue == "D2",1],
                  tSNE2 = umap.cor$layout[colData(cur_sce)$Tissue == "D2",2],
...
ggplot(data.frame(tSNE1 = umap.cor$layout[cluster == 1,1],
                  tSNE2 = umap.cor$layout[cluster == 1,2],
...
# Visualize gene expression
ggplot(data.frame(tSNE1 = umap.cor$layout[cluster == 6,1],
                  tSNE2 = umap.cor$layout[cluster == 6,2],
