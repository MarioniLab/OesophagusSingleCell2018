...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, 
        encoding = encoding, output_file = '../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Trajectories/Trajectory_NE.html') })
---
...
ggplot(data.frame(PC1 = corrected[1,],
                  PC2 = corrected[2,],
                  CSTB = logcounts(sce)[rowData(sce)$Symbol == "CSTB",])) +
  geom_point(aes(x = PC1, y = PC2, colour = CSTB)) +
...
ggplot(data.frame(tsne1 = tsne$Y[,1],
                  tsne2 = tsne$Y[,2],
                  CSTB = logcounts(sce)[rowData(sce)$Symbol == "CSTB",])) +
  geom_point(aes(x = tsne1, y = tsne2, colour = CSTB)) + scale_colour_viridis()
...
ggplot(data.frame(DC1 = dm$DC1,
                  DC2 = dm$DC2,
                  CSTB = logcounts(sce)[rowData(sce)$Symbol == "CSTB",])) +
  geom_point(aes(x = DC1, y = DC2, colour = CSTB)) + scale_colour_viridis()
```
...
ggplot(data.frame(phate1 = tree.phate$embedding[,1],
                  phate2 = tree.phate$embedding[,2],
                  CSTB = logcounts(sce)[rowData(sce)$Symbol == "CSTB",])) +
  geom_point(aes(x = phate1, y = phate2, colour = CSTB)) + scale_colour_viridis()
```
...
ggplot(data.frame(UMAP1 = umap.all$layout[,1],
                  UMAP2 = umap.all$layout[,2],
                  CSTB = logcounts(sce)[rowData(sce)$Symbol == "CSTB",])) +
  geom_point(aes(x = UMAP1, y = UMAP2, colour = CSTB)) + scale_colour_viridis()
```
...
ggplot(data.frame(tsne1 = tsne$Y[,1],
  ...
  geom_point(aes(x = tsne1, y = tsne2, colour = PTMA)) + scale_colour_viridis()
```
