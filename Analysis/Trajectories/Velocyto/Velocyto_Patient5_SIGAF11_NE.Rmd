---
title: "Velocyto SIGAF11 NE Patient 5"
author: "Nils Eling"
date: "`r Sys.Date()`"
output: 
  html_document:
...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, 
        encoding = encoding, output_file = '../../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Velocyto/Patient5_SIGAF11_NE.html') })
---
...
library(Rtsne)
library(scater)
loom.data <- read.loom.matrices("../../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Velocyto/SIGAF11.loom")

# Load filtered counts
sce <- readRDS("../../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/All_sce.rds")
sce <- sce$Patient5_SIGAF11_NE
sce <- normalize(sce)

spliced.dat <- loom.data$spliced
spliced.dat <- spliced.dat[,paste("SIGAF11:", sub("-1", "x", sce$Barcode), sep = "")]
...
ggplot(data.frame(tSNE1 = emb[,1],
                  tSNE2 = emb[,2], 
                  gene = logcounts(sce)[rowData(sce)$Symbol == "PTMA",])) + 
