...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, 
        encoding = encoding, output_file = '../../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Velocyto/Patient13_SIGAC8_SMG.html') })
---
...
library(Rtsne)
library(scater)
loom.data <- read.loom.matrices("../../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Velocyto/Patient13_SIGAC8_SMG.loom")

# Load filtered counts
sce <- readRDS("../../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/All_sce.rds")
sce <- sce$Patient13_SIGAC8_SMG
sce <- normalize(sce)

spliced.dat <- loom.data$spliced
spliced.dat <- spliced.dat[,paste("Patient13_SIGAC8_SMG:", sub("-1", "x", sce$Barcode), sep = "")]
