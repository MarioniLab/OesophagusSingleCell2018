---
title: "Velocyto SIGAA4 NE Patient 7"
author: "Nils Eling"
date: "`r Sys.Date()`"
output: 
  html_document:
...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, 
        encoding = encoding, output_file = '../../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Velocyto/Patient7_SIGAA4_NE.html') })
---
...
library(Rtsne)
library(scater)
loom.data <- read.loom.matrices("../../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Velocyto/SIGAA4.loom")

# Load filtered counts
sce <- readRDS("../../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/All_sce.rds")
sce <- sce$Patient7_SIGAA4_NE
sce <- normalize(sce)

spliced.dat <- loom.data$spliced
spliced.dat <- spliced.dat[,paste("SIGAA4:", sub("-1", "x", sce$Barcode), sep = "")]
