...
ggplot(data.frame(tSNE1 = tsne$Y[,1],
                  tSNE2 = tsne$Y[,2],
                  clusters = as.factor(clusters))) + geom_point(aes(tSNE1, tSNE2, colour = clusters))
...
markers <- findMarkers(sce, clusters = clusters, design = des)
...
write.xlsx(markers.spec, paste("../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Marker_genes/Global/", i, "/Marker_genes.xlsx", sep = ""))
