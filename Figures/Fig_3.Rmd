...
# Save results
write.xlsx(out, file = "../../../Dropbox (Cambridge University)/Origin_of_BE_draft/Figures/Supplemental_tables/Table_S7.xlsx")
```
...
# Save results
write.xlsx(out_spec, file = "../../../Dropbox (Cambridge University)/Origin_of_BE_draft/Figures/Supplemental_tables/Table_S8.xlsx")
```
...
pdf("../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Figure_3/Heatmap_marker_genes.scaled.pdf", 
    width = 10, height = 5)
pheatmap(for.plot[,ind_order], cluster_rows = FALSE, cluster_cols = FALSE,
