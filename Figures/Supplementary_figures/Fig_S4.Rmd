...
ggsave("../../../../Dropbox (Personal)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S4/All_data_uncorrected.pdf", tsne.uncorrected, width = 12, height = 7)
```
...
ggsave("../../../../Dropbox (Personal)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S4/All_data_corrected.pdf", tsne.corrected, width = 12, height = 7)
```
...
ggsave("../../../../Dropbox (Personal)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S4/All_data_corrected_highQuality.pdf", tsne.corrected.high.quality, width = 12, height = 7)
```
...
ggsave("../../../../Dropbox (Personal)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S4/All_data_corrected_final.pdf", tsne.corrected.final, width = 12, height = 7)
```