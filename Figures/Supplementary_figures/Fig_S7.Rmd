---
title: "Figure S5: Characterization of BE cells"
author: "Nils Eling"
date: "`r Sys.Date()`"
output: 
  html_document:
...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, 
        encoding = encoding, output_file = '../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Fig_S5.html') })
---
...
ggsave("../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/Figure_S5/BE_tsne.pdf", tsne.BE, width = 6, height = 5)
```
...
# Save as table
write.xlsx(DE.genes, file = "../../../../Dropbox (Cambridge University)/Origin_of_BE_draft/Figures/Supplemental_tables/Table_S6.xlsx")
```
...
pdf(file = "../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/Figure_S5/BE_heatmap.pdf", height = 7, width = 7)
