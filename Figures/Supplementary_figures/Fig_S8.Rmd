...
pdf("../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S8/Tree_all_genes.pdf", width = 10, height = 10)
...
ggsave("../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S8/PCA_cell_types_all_genes.pdf", pca.p, width = 10, height = 10)
```
...
sce.new <- readRDS("../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/All_corrected_sce.rds")
...
# Calculate spearman correlation between cell types
dend <- hclust(as.dist(sqrt(1 - cor(log2(mat + 1), method = "spearman"))/2), method = "ward.D2")
pdf("../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S8/Tree_HVG.pdf", width = 10, height = 10)
plot(as.phylo(dend), type = "fan", 
     tip.color = metadata(sce)$colour_vector[sub("_[0-9]*$", "", unique(clusters))])
dev.off()
...
ggsave("../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S8/PCA_cell_types_HVG.pdf", pca.p, width = 10, height = 10)
```
...
# Calculate spearman correlation between cell types
dend <- hclust(as.dist(sqrt(1 - cor(log2(mat + 1), method = "spearman"))/2), method = "ward.D2")
pdf("../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S8/Tree_all_genes.batch_scaled.pdf", width = 10, height = 10)
plot(as.phylo(dend), type = "fan", 
     tip.color = metadata(sce)$colour_vector[sub("_[0-9]*$", "", unique(clusters))])
dev.off()
```
...
# Calculate spearman correlation between cell types
dend <- hclust(as.dist(sqrt(1 - cor(log2(mat + 1), method = "spearman"))/2), method = "ward.D2")
pdf("../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S8/Tree_HVG.batch_scaled.pdf", width = 10, height = 10)
plot(as.phylo(dend), type = "fan", 
     tip.color = metadata(sce)$colour_vector[sub("_[0-9]*$", "", unique(clusters))])
dev.off()
```
