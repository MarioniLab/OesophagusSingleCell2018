---
title: "Figure S2: Computational processing of all data"
author: "Nils Eling"
date: "`r Sys.Date()`"
output: 
  html_document:
...
ggsave("../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/Figure_S2/All_data_uncorrected.pdf", tsne.uncorrected, width = 12, height = 7)
```
...
n <- names(sce.list)
sce.list <- sce.list[c(which(grepl("NE", n)), which(grepl("GOJ", n)),
                       which(grepl("SCJ", n)), which(grepl("GC", n)),
...
ggsave("../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/Figure_S2/All_data_corrected.pdf", tsne.corrected, width = 12, height = 7)
```
...
ggsave("../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/Figure_S2/All_data_corrected_highQuality.pdf", tsne.corrected.high.quality, width = 12, height = 7)
```
...
ggsave("../../../../Dropbox (Cambridge University)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/Figure_S2/All_data_corrected_final.pdf", tsne.corrected.final, width = 12, height = 7)
```