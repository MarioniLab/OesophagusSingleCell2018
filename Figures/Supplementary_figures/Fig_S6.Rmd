...
p.all.cells.tissue_type <- ggplot(data.frame(tsne1 = reducedDims(cur_sce)$TSNE[,1],
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        panel.background = element_blank(), 
        axis.line = element_line(colour = "grey"))
ggsave("../../../../Dropbox (Personal)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S6/All_cells.pdf", p.all.cells.tissue_type, width = 7, height = 5)
...
p.all.cells.cell_type <- ggplot(data.frame(tsne1 = reducedDims(cur_sce)$TSNE[,1],
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        panel.background = element_blank(), 
        axis.line = element_line(colour = "grey"))
ggsave("../../../../Dropbox (Personal)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S6/All_cells.pdf", p.all.cells.cell_type, width = 7, height = 5)
...
p.all.cells.patient <- ggplot(data.frame(tsne1 = reducedDims(cur_sce)$TSNE[,1],
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        panel.background = element_blank(), 
        axis.line = element_line(colour = "grey"))
ggsave("../../../../Dropbox (Personal)/Oesophagus_single_cell/Results/Figures/Supplementary_figures/S6/All_cells.pdf", p.all.cells.patient, width = 7, height = 5)
```
